    ...
    toast(
      <div className="w-full max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="bg-yellow-500 px-6 py-4 flex items-center justify-between">
          <h3 className="text-white font-semibold text-lg">Confirm Reset</h3>
        ...
        <div className="px-6 py-6">
          <p className="text-gray-700 text-sm leading-relaxed">
            Are you sure you want to reset the spent amount to $0? This action cannot be undone.
          </p>
        </div>
          ...
          <button
            onClick={async () => {
              try {
                ...
                toast.dismiss()
                toast.error("Failed to reset budget spending", {
                  duration: 4000,
                  position: "top-center",
                })
              }
