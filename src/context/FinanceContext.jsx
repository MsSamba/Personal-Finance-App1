...
// const fetchBudgetAnalytics = useCallback(async ({ period = "current" } = {}) => {
//   setState((prev) => ({ ...prev, budgetAnalyticsLoading: true }))
//   try {
//     const res = await budgetAPI.getBudgetAnalytics(period)
//     setState((prev) => ({
//       ...prev,
//       budgetAnalytics: res.data,
//       budgetAnalyticsLoading: false,
//     }))
//   } catch (err) {
